...
/* ----------------------------------------------------------
   ...
   ---------------------------------------------------------- */
export const audio = { ctx: null as AudioContext | null, last: 0 };

export function tone(frequency: number, duration: number, peak: number, type: OscillatorType): void {
...
export function hoverSound(): void {
    const now = Date.now();
...
export function clickSound(kind: "primary" | "warm"): void {
