...
import { bodyEditor, IBody, IEmbed } from "../layout/BodyEditor.js";
...
export function renderMessages(guildId: string): void {
    ...
    function messageBody(message: IMessage): HTMLElement {
        ...
        const editor = bodyEditor(draft, {
            kinds: data!.kinds,
            context,
            defaultEmbed: () => structuredClone(data!.defaults.embed),
            touch,
            extras: () => buttonPreview(draft) ?? null,
        });
